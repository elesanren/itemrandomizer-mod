...
// Type: StartingAbilityPicker.SkillRandomizer
...
public static class SkillRandomizer
{
  ...
  public static void SetSeed(int seed)
  {
    ...
    Plugin.Log.LogInfo((object) $"SkillRandomizer seed set to: {seed}");
  }

  public static void ResetSeed()
  {
    SkillRandomizer.SetSeed(SkillRandomizer._currentSeed);
    Plugin.Log.LogInfo((object) "SkillRandomizer seed reset.");
  }
  ...
  private static void EnsureRng()
  {
    ...
    Plugin.Log.LogWarning((object) "SkillRandomizer RNG was not initialized, using default seed.");
  }
  ...
  public static void GiveRandomSkill()
  {
    ...
    try
    {
      ...
      if (instance == null)
      {
        Plugin.Log.LogError((object) "PlayerData.instance 为空");
      }
      else
      {
        ...
        {
          Plugin.Log.LogInfo((object) "所有技能已解锁，给予默认技能 Wall Jump");
  ...
  public static void GiveWallJump()
  {
    try
    {
      ...
      if (flag)
        return;
      Plugin.Log.LogWarning((object) "未找到有效的爬墙技能字段");
    }
    catch (Exception ex)
    {
